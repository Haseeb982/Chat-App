...
const Auth = () => {
  ...
  return (
    <div className="bg-[#191919] min-h-screen flex items-center justify-center">
      <div className="w-full max-w-sm mx-auto overflow-hidden bg-white rounded-xl shadow-md">
        <div className="px-6 py-4">
          ...
          <Tabs defaultValue="login">
            ...
            <TabsContent value="signup" className="flex flex-col gap-4">
              ...
              />
              <Button
                className="w-full bg-blue-500 rounded-full text-white hover:bg-blue-600"
